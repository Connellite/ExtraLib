...
public final class ResultSetStringStream {
     ...
     */
    public static Stream<Map<String, String>> stream(Connection connection, String sql, Object... params) throws SQLException {
        ResultSetStringIterator it;
        try {
            it = new ResultSetStringIterator(connection, sql, params);
     ...
     */
    public static Stream<Map<String, String>> stream(NamedPreparedStatement nps) throws SQLException {
        ResultSetStringIterator it;
        try {
            it = new ResultSetStringIterator(nps);
        } catch (SQLException se) {
            throw se;
        } catch (Exception e) {
            throw new SQLException(e);
