...
public final class HashPrefixSqlParser extends CachingSqlParser {
    /**
     ...
     * <p>
     * Jdbi reference:
     * https://github.com/jdbi/jdbi/blob/6e959ba70365fb0e15f19f39e8b2bf32d4998b6c/core/src/main/java/org/jdbi/v3/core/statement/HashPrefixSqlParser.java
     */
    @Override
    ...
    ParsedSql internalParse(String sql) {
        ...
        HashStatementLexer lexer = new HashStatementLexer(sql);
